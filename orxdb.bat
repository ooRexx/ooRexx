...
set OR_KERNELPATH=%INTERPRETER%;%INTERPRETER_CLASSES%;%INTERPRETER_RUNTIME%;%BEHAVIOUR%;%CONCURRENCY%;%EXECUTION%;%INSTRUCTIONS%;%PARSER%;%KPLATFORM%;%INT_PLATFORM%;%STREAM%;%INTERPRETER_MESSAGES
set OR_KERNELINCL=-I%INTERPRETER%\ -I%INTERPRETER_CLASSES%\ -I%INTERPRETER_RUNTIME%\ -I%BEHAVIOUR%\ -I%CONCURRENCY%\ -I%EXECUTION%\ -I%EXPRESSIONS%\ -I%INSTRUCTIONS%\ -I%PARSER%\ -I%INT_PLATFORM%\ -I%STREAM%\ -I%INTERPRETER_MESSAGES%\
REM
