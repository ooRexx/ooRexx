...
1. Download and install CMake. For Windows, Linux and macOS go to 
   ...
   For *nix distribution you can also install CMake from your distribution's
   repository.
...
3. Now create a subdirectory on your disk that is NOT in the ooRexx source tree
   ...
   location. Preferred is a build dir at the same level (parallel to) the source dir. 
4. You are now ready to create everything necessary in building ooRexx on your
   ...
   We do not use Cpack for macOS but if you want to create a Drag&Drop dmg
   installer you will have to add -DBUILD_DMG=1 to the CMake command. This will
   create a commandfile build_macOS_dmg.sh for you in the build dir. Run it to
